# FbShort by PROF
import os, sys
print '\x1b[1;32m*Masukan "User: prof" dan "Password: ganteng"'
print '\x1b[1;32mSilahkan Login Script'
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6281326977165&text=Assalamualaikum')
...
if sandi == 'ganteng' and user == 'prof':
